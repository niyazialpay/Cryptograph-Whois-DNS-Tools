...
{
    public partial class frmPTR : Form
    {
        public frmPTR()
        {
            InitializeComponent();
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            if (UserInputs != null)
            {
                try
                {
                    ...
                    lvimx.SubItems.Add(dns.PTRRecord(UserInputs["url"]));
        ...
        private void frmPTR_Load(object sender, EventArgs e)
        {
            txtUrl.Focus();
        }
        ...
        private void frmPTR_KeyDown(object sender, KeyEventArgs e)
        {
