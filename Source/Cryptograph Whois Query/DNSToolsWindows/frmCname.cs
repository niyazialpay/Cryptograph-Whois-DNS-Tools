...
{
    public partial class frmCname : Form
    {
        public frmCname()
        {
            InitializeComponent();
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            if (UserInputs != null)
            {
                try
                {
                    ...
                    foreach (string item in dns.CnameRecord(UserInputs["url"]))
                    {
        ...
        private void frmCname_Load(object sender, EventArgs e)
        {
            txtUrl.Focus();
        }
        ...
        private void frmCname_KeyDown(object sender, KeyEventArgs e)
        {
